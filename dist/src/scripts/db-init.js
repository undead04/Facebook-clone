...
async function initRabbitMQ() {
  try {
    ...
    await channel.assertExchange(emailRetryExchange, "direct", { durable: true });
    ...
    await channel.bindQueue(emailRetryQueue, emailRetryExchange, emailRetryRoutingKey);
    ...
    await channel.assertExchange(postRetryExchange, "direct", { durable: true });
    ...
    await channel.bindQueue(emailRetryQueue, postRetryExchange, postRetryRoutingKey);
    ...
    await channel.assertExchange(notifiRetryExchange, "direct", { durable: true });
    ...
    await channel.bindQueue(notifiRetryQueue, notifiRetryExchange, notifiRetryRoutingKey);
